...
level_structure = [{"size": ((WIDTH / 400) * 400, (HEIGHT / 225) * 50),"position": ((WIDTH / 400) * 0, (HEIGHT / 225) * 175), "type": "solid"},
                   {"size": ((WIDTH / 400) * 40, (HEIGHT / 225) * 10),"position": ((WIDTH / 400) * 25, (HEIGHT / 225) * 140), "type": "solid"},
                   {"size": ((WIDTH / 400) * 40, (HEIGHT / 225) * 10),"position": ((WIDTH / 400) * 335, (HEIGHT / 225) * 140), "type": "solid"},
                   {"size": ((WIDTH / 400) * 200, (HEIGHT / 225) * 10),"position": ((WIDTH / 400) * 100, (HEIGHT / 225) * 100), "type": "solid"}]
